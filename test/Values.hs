...
typeEdges =
  Set.fromList
    [
     ...
     ("BigNat (field Integer.Jn#[1])",["BigNat","ByteArray# (field BigNat.BN#[1])"]),
     ("BigNat (field Integer.Jp#[1])",["BigNat","ByteArray# (field BigNat.BN#[1])"]),
     ("ByteArray#",[]),
     ("ByteArray# (field BigNat.BN#[1])",["ByteArray#"]),
     ("Char",["Char# (field Char.C#[1])"]),
     ("Char#",[]),
     ("Char# (field Char.C#[1])",["Char#"]),
     ("Int",["Int# (field Int.I#[1])"]),
     ("Int (field NameFlavour.NameL[1])",["Int","Int# (field Int.I#[1])"]),
     ("Int (field NameFlavour.NameU[1])",["Int","Int# (field Int.I#[1])"]),
     ("Int (field Type.PromotedTupleT[1])",["Int","Int# (field Int.I#[1])"]),
     ("Int (field Type.TupleT[1])",["Int","Int# (field Int.I#[1])"]),
     ("Int (field Type.UnboxedTupleT[1])",["Int","Int# (field Int.I#[1])"]),
     ("Int#",[]),
     ("Int# (field Int.I#[1])",["Int#"]),
     ("Int# (field Integer.S#[1])",["Int#"]),
     ("Integer",["BigNat (field Integer.Jn#[1])","BigNat (field Integer.Jp#[1])","Int# (field Integer.S#[1])"]),
     ("Integer (field TyLit.NumTyLit[1])",["Integer","BigNat (field Integer.Jn#[1])","BigNat (field Integer.Jp#[1])","Int# (field Integer.S#[1])"]),
     ("ModName",["[Char] (aka String, field ModName.ModName[1])"]),
     ("ModName (field NameFlavour.NameG[3])",["ModName","[Char] (aka String, field ModName.ModName[1])"]),
     ("ModName (field NameFlavour.NameQ[1])",["ModName","[Char] (aka String, field ModName.ModName[1])"]),
     ("Name",["OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field TyVarBndr.KindedTV[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field TyVarBndr.PlainTV[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field Type.ConT[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field Type.PromotedT[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field Type.VarT[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ...
     ("NameSpace",[]),
     ("NameSpace (field NameFlavour.NameG[1])",["NameSpace"]),
     ("OccName",["[Char] (aka String, field OccName.OccName[1])"]),
     ("OccName (field Name.Name[1])",["OccName","[Char] (aka String, field OccName.OccName[1])"]),
     ("PkgName",["[Char] (aka String, field PkgName.PkgName[1])"]),
     ("PkgName (field NameFlavour.NameG[2])",["PkgName","[Char] (aka String, field PkgName.PkgName[1])"]),
     ("TyLit",["Integer (field TyLit.NumTyLit[1])","[Char] (aka String, field TyLit.StrTyLit[1])"]),
     ("TyLit (field Type.LitT[1])",["TyLit","Integer (field TyLit.NumTyLit[1])","[Char] (aka String, field TyLit.StrTyLit[1])"]),
     ...
     ("[Char] (aka String)",["Char","[]"]),
     ("[Char] (aka String, field ModName.ModName[1])",["Char","[]","[Char] (aka String)"]),
     ("[Char] (aka String, field OccName.OccName[1])",["Char","[]","[Char] (aka String)"]),
     ("[Char] (aka String, field PkgName.PkgName[1])",["Char","[]","[Char] (aka String)"]),
     ("[Char] (aka String, field TyLit.StrTyLit[1])",["Char","[]","[Char] (aka String)"]),
     ("[TyVarBndr]",["TyVarBndr","[]"]),
     ("[TyVarBndr] (field Type.ForallT[1])",["[TyVarBndr]","TyVarBndr","[]"]),
     ("[Type] (aka Cxt)",["[]","Type (aka Kind, aka Pred)"]),
     ("[Type] (aka Cxt, field Type.ForallT[2])",["[]","[Type] (aka Cxt)","Type (aka Kind, aka Pred)"]),
     ("[]",[])
#else
     ("ByteArray#",[]),
     ("ByteArray# (field Integer.J#[2])",["ByteArray#"]),
     ("Char",["Char# (field Char.C#[1])"]),
     ("Char#",[]),
     ("Char# (field Char.C#[1])",["Char#"]),
     ("Int",["Int# (field Int.I#[1])"]),
     ...
     ("Int#",[]),
     ("Int# (field Int.I#[1])",["Int#"]),
     ("Int# (field Integer.J#[1])",["Int#"]),
     ("Int# (field Integer.S#[1])",["Int#"]),
     ("Int# (field NameFlavour.NameL[1])",["Int#"]),
     ("Int# (field NameFlavour.NameU[1])",["Int#"]),
     ("Integer",["Int# (field Integer.J#[1])","ByteArray# (field Integer.J#[2])","Int# (field Integer.S#[1])"]),
     ("Integer (field TyLit.NumTyLit[1])",["Integer","Int# (field Integer.J#[1])","ByteArray# (field Integer.J#[2])","Int# (field Integer.S#[1])"]),
     ("ModName",["[Char] (aka String, field ModName.ModName[1])"]),
     ("ModName (field NameFlavour.NameG[3])",["ModName","[Char] (aka String, field ModName.ModName[1])"]),
     ("ModName (field NameFlavour.NameQ[1])",["ModName","[Char] (aka String, field ModName.ModName[1])"]),
     ("Name",["OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field Pred.ClassP[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field TyVarBndr.KindedTV[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field TyVarBndr.PlainTV[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field Type.ConT[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ("Name (field Type.PromotedT[1])",["Name","OccName (field Name.Name[1])","NameFlavour (field Name.Name[2])"]),
     ...
     ("[Char] (aka String, field TyLit.StrTyLit[1])",["Char","[]","[Char] (aka String)"]),
     ("[Pred] (aka Cxt)",["Pred","[]"]),
     ("[Pred] (aka Cxt, field Type.ForallT[2])",["Pred","[]","[Pred] (aka Cxt)"]),
     ("[TyVarBndr]",["TyVarBndr","[]"]),
     ("[TyVarBndr] (field Type.ForallT[1])",["[TyVarBndr]","TyVarBndr","[]"]),
     ("[Type]",["[]","Type (aka Kind)"]),
     ("[Type] (field Pred.ClassP[2])",["[Type]","[]","Type (aka Kind)"]),
     ("[]",[])
#endif
    ]
